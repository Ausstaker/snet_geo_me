...
import au.com.ausstaker.cage.compute.GeolocationResult;
...
public class KmlFileStaticHelpers {
    ...
    public static String exportGeoMissionToKml(GeoMission geoMission) {
        try
        {
            ...
            if (gm.getShowMeas()) {
                ...
                color.appendChild(doc.createTextNode("ff888888"));
        ...
        try {
            Target target = geoMission.getTarget();
                if (target.getTrue_current_loc() != null) {
                    ...
                    crosshairIconHref.appendChild(doc.createTextNode("http://maps.google.com/mapfiles/kml/shapes/star.png"));
    ...
    public static void exportTargetEstimationResult(Document doc, Element dnode, GeoMission geoMission) {
        try
        {
            Target target = geoMission.getTarget();
                ...
                Element crosshairIconHref = doc.createElement("href");
                crosshairIconHref.appendChild(doc.createTextNode("http://maps.google.com/mapfiles/kml/shapes/open-diamond.png"));
